...
ATerm io_stream_wrap_1_0 (StrSL sl, StrCL k_8, ATerm t);
ATerm main_0_0 (StrSL sl, ATerm t);
static ATerm lifted0 (StrSL sl, ATerm t);
ATerm main_rtg2dfta_0_0 (StrSL sl, ATerm t);
ATerm main_0_0 (StrSL sl, ATerm t)
{
__tracing_table[__tracing_table_counter++] = "main_0_0";
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = main_rtg2dfta_0_0(sl, t);
if((t == NULL))
goto fail2 ;
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
...
ATerm main_rtg2dfta_0_0 (StrSL sl, ATerm t)
{
__tracing_table[__tracing_table_counter++] = "main_rtg2dfta_0_0";
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
sl_vars(1);
{
...
closures_index++;
closures[closures_index].fun = &(main_rtg2dfta_0_0);
closures[closures_index].sl = NULL;
SRTS_register_function((ATerm)ATmakeAppl0(ATmakeSymbol("main_rtg2dfta_0_0", 0, ATtrue)), &(closures[closures_index]));
closures_index++;
}
