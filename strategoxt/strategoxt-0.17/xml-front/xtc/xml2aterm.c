...
term19 = term18;
ATprotect(&(term20));
term20 = (ATerm) ATmakeAppl(ATmakeSymbol("xml-info2data", 0, ATtrue));
ATprotect(&(term21));
term21 = term20;
ATprotect(&(term22));
term22 = (ATerm) ATmakeAppl(ATmakeSymbol("parse-xml-info", 0, ATtrue));
ATprotect(&(term23));
term23 = term22;
ATprotect(&(term24));
...
ATerm main_xml2aterm_0_0 (StrSL sl, ATerm t);
...
ATerm main_xml2aterm_0_0 (StrSL sl, ATerm t)
{
__tracing_table[__tracing_table_counter++] = "main_xml2aterm_0_0";
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
{
...
struct str_closure z_69 = { &(pass_verbose_0_0) , sl_up(sl) };
...
closures_index++;
closures[closures_index].fun = &(main_xml2aterm_0_0);
closures[closures_index].sl = NULL;
SRTS_register_function((ATerm)ATmakeAppl0(ATmakeSymbol("main_xml2aterm_0_0", 0, ATtrue)), &(closures[closures_index]));
closures_index++;
