...
{
ATprotect(&(term0));
term0 = (ATerm) ATmakeAppl(ATmakeSymbol("pp-xml-doc", 0, ATtrue));
ATprotect(&(term1));
term1 = term0;
ATprotect(&(term2));
term2 = (ATerm) ATmakeAppl(ATmakeSymbol("xml-info2xml-doc", 0, ATtrue));
ATprotect(&(term3));
term3 = term2;
}
...
ATerm xtc_io_wrap_1_0 (StrSL sl, StrCL b_1, ATerm t);
ATerm xtc_transform_1_0 (StrSL sl, StrCL b_0, ATerm t);
...
sl_decl(sl);
{
struct str_closure v_68 = { &(lifted0) , &(frame) };
StrCL lifted0_cl = &(v_68);
...
sl_decl(sl);
{
struct str_closure t_68 = { &(lifted2) , &(frame) };
StrCL lifted2_cl = &(t_68);
struct str_closure u_68 = { &(lifted1) , &(frame) };
StrCL lifted1_cl = &(u_68);
t = xtc_transform_1_0(sl_up(sl), lifted1_cl, t);
if((t == NULL))
goto fail1 ;
t = xtc_transform_1_0(sl_up(sl), lifted2_cl, t);
if((t == NULL))
goto fail1 ;
}
__tracing_table[--__tracing_table_counter] = NULL;
