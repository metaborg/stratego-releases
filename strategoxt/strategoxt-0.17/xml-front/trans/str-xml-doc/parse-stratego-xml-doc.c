...
term13 = term12;
ATprotect(&(term14));
term14 = (ATerm) ATmakeAppl(ATmakeSymbol("Stratego-xml.tbl", 0, ATtrue));
ATprotect(&(term15));
term15 = term14;
ATprotect(&(term16));
term16 = (ATerm) ATmakeAppl(ATmakeSymbol("StrategoModule", 0, ATtrue));
ATprotect(&(term17));
term17 = term16;
}
...
sl_decl(sl);
{
struct str_closure y_70 = { &(lifted3) , &(frame) };
StrCL lifted3_cl = &(y_70);
...
sl_decl(sl);
{
struct str_closure t_70 = { &(lifted6) , &(frame) };
StrCL lifted6_cl = &(t_70);
struct str_closure u_70 = { &(pass_verbose_0_0) , sl_up(sl) };
StrCL lifted7_cl = &(u_70);
struct str_closure w_70 = { &(lifted4) , &(frame) };
StrCL lifted4_cl = &(w_70);
struct str_closure x_70 = { &(lifted5) , &(frame) };
StrCL lifted5_cl = &(x_70);
t = xtc_sglr_2_0(sl_up(sl), lifted4_cl, lifted5_cl, t);
if((t == NULL))
goto fail6 ;
