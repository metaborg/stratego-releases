...
{
ATprotect(&(term0));
term0 = (ATerm) ATmakeAppl(ATmakeSymbol("char-test", 0, ATtrue));
ATprotect(&(term1));
term1 = term0;
ATprotect(&(term2));
term2 = (ATerm) ATmakeAppl(ATmakeSymbol("is-not-num-test", 0, ATtrue));
ATprotect(&(term3));
term3 = term2;
ATprotect(&(term4));
term4 = (ATerm) ATmakeInt(130);
ATprotect(&(term5));
term5 = term4;
ATprotect(&(term6));
term6 = (ATerm) ATmakeAppl(ATmakeSymbol("is-num-test", 0, ATtrue));
ATprotect(&(term7));
term7 = term6;
ATprotect(&(term8));
term8 = (ATerm) ATmakeInt(50);
ATprotect(&(term9));
term9 = term8;
ATprotect(&(term10));
term10 = (ATerm) ATmakeAppl(ATmakeSymbol("is-alphanum-test", 0, ATtrue));
ATprotect(&(term11));
term11 = term10;
}
...
sl_decl(sl);
{
struct str_closure g_62 = { &(lifted10) , &(frame) };
StrCL lifted10_cl = &(g_62);
struct str_closure h_62 = { &(lifted11) , &(frame) };
StrCL lifted11_cl = &(h_62);
struct str_closure i_62 = { &(lifted12) , &(frame) };
StrCL lifted12_cl = &(i_62);
struct str_closure j_62 = { &(lifted13) , &(frame) };
StrCL lifted13_cl = &(j_62);
struct str_closure k_62 = { &(lifted2) , &(frame) };
StrCL lifted2_cl = &(k_62);
struct str_closure l_62 = { &(is_num_0_0) , sl_up(sl) };
StrCL lifted3_cl = &(l_62);
struct str_closure m_62 = { &(lifted4) , &(frame) };
StrCL lifted4_cl = &(m_62);
struct str_closure n_62 = { &(lifted5) , &(frame) };
...
struct str_closure p_62 = { &(is_alphanum_0_0) , sl_up(sl) };
StrCL lifted7_cl = &(p_62);
struct str_closure q_62 = { &(lifted8) , &(frame) };
StrCL lifted8_cl = &(q_62);
struct str_closure r_62 = { &(lifted9) , &(frame) };
