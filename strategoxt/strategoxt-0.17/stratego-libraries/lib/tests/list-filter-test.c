...
{
ATprotect(&(term0));
term0 = (ATerm) ATmakeAppl(ATmakeSymbol("list-filter-test", 0, ATtrue));
ATprotect(&(term1));
term1 = term0;
ATprotect(&(term2));
...
term9 = term8;
ATprotect(&(term10));
term10 = (ATerm) ATmakeAppl(ATmakeSymbol("b", 0, ATtrue));
ATprotect(&(term11));
term11 = term10;
ATprotect(&(term12));
term12 = (ATerm) ATmakeAppl(ATmakeSymbol("c", 0, ATtrue));
ATprotect(&(term13));
term13 = term12;
ATprotect(&(term14));
...
term19 = term18;
ATprotect(&(term20));
term20 = (ATerm) ATmakeAppl(sym__2, term11, term19);
ATprotect(&(term21));
term21 = term20;
ATprotect(&(term22));
term22 = (ATerm) ATmakeAppl(ATmakeSymbol("test2", 0, ATtrue));
ATprotect(&(term23));
term23 = term22;
}
...
ATerm partition_1_0 (StrSL sl, StrCL o_40, ATerm t);
ATerm filter_1_0 (StrSL sl, StrCL b_40, ATerm t);
...
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = (ATerm) ATmakeAppl(sym__2, (ATerm)ATinsert(ATinsert(ATempty, term11), term5), (ATerm) ATinsert(ATinsert(ATempty, term7), term19));
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
fail13 :
--__tracing_table_counter;
...
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term7), term11), term5), term19);
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
fail12 :
--__tracing_table_counter;
...
sl_decl(sl);
{
struct str_closure n_62 = { &(is_string_0_0) , sl_up(sl) };
StrCL lifted9_cl = &(n_62);
t = partition_1_0(sl_up(sl), lifted9_cl, t);
if((t == NULL))
goto fail11 ;
}
__tracing_table[--__tracing_table_counter] = NULL;
...
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = (ATerm) ATinsert(ATinsert(ATempty, term9), term17);
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
fail8 :
--__tracing_table_counter;
...
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = (ATerm) ATinsert(ATinsert(ATinsert(ATinsert(ATempty, term9), term15), term17), term21);
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
fail7 :
--__tracing_table_counter;
...
sl_decl(sl);
{
struct str_closure i_62 = { &(lifted4) , &(frame) };
StrCL lifted4_cl = &(i_62);
t = filter_1_0(sl_up(sl), lifted4_cl, t);
if((t == NULL))
goto fail5 ;
}
__tracing_table[--__tracing_table_counter] = NULL;
...
if(!((ATgetSymbol(trm0) == ATmakeSymbol("a", 0, ATtrue))))
goto fail6 ;
{
