...
term3 = term2;
ATprotect(&(term4));
term4 = (ATerm) ATmakeAppl(ATmakeSymbol("pp-table-pretty.pp.af", 0, ATtrue));
ATprotect(&(term5));
term5 = term4;
ATprotect(&(term6));
...
ATerm io_pp_pp_table_0_0 (StrSL sl, ATerm t);
ATerm main_0_0 (StrSL sl, ATerm t)
{
__tracing_table[__tracing_table_counter++] = "main_0_0";
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
t = io_pp_pp_table_0_0(sl, t);
if((t == NULL))
goto fail6 ;
__tracing_table[--__tracing_table_counter] = NULL;
return(t);
...
ATerm io_pp_pp_table_0_0 (StrSL sl, ATerm t)
{
__tracing_table[__tracing_table_counter++] = "io_pp_pp_table_0_0";
__tracing_table[__tracing_table_counter] = NULL;
sl_decl(sl);
{
...
closures_index++;
closures[closures_index].fun = &(io_pp_pp_table_0_0);
closures[closures_index].sl = NULL;
SRTS_register_function((ATerm)ATmakeAppl0(ATmakeSymbol("io_pp_pp_table_0_0", 0, ATtrue)), &(closures[closures_index]));
closures_index++;
}
