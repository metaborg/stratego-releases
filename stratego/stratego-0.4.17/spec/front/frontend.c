...
PROC(_stratego_init_afuns)
  ...
  MOVE(b_61,ATmakeAFun("StratRule",3,0));
  MOVE(t_60,ATmakeAFun("Seq",2,0));
  MOVE(r_60,ATmakeAFun("Seqs",1,0));
  MOVE(g_59,ATmakeAFun("Cong",2,0));
  MOVE(y_58,ATmakeAFun("BAM",3,0));
  MOVE(v_58,ATmakeAFun("BA",2,0));
  MOVE(r_58,ATmakeAFun("AM",2,0));
  MOVE(n_58,ATmakeAFun("MA",2,0));
  MOVE(l_58,ATmakeAFun("Match",1,0));
  MOVE(j_58,ATmakeAFun("Build",1,0));
  ...
  MOVE(r_6,ATmakeAFun("Input",1,0));
  MOVE(e_6,ATmakeAFun("Program",1,0));
  MOVE(y_5,ATmakeAFun("Help",0,0));
  MOVE(v_5,ATmakeAFun("Undefined",1,0));
...
PROC(_stratego_j_96)
  ...
  goto f_26;
  f_26 :
  TestFunFC(e_18,&&y_20,Egetd(10,1));
  MoveArg(10,2,10,1,0);
  Rpush(p_20);
  goto h_49;
  y_20 :
...
PROC(_stratego_x_96)
  ...
  goto n_86;
  n_86 :
  TestFunFC(p_0,&&u_53,Egetd(0,5));
  MoveArg(0,1,0,5,0);
  MoveArg(0,2,0,5,1);
  goto o_86;
  o_86 :
  TestFunFC(p_0,&&v_53,Egetd(0,2));
  MoveArg(0,3,0,2,0);
  MoveArg(0,4,0,2,1);
  goto p_86;
  p_86 :
  TestFunFC(s_0,&&w_53,Egetd(0,4));
  Cpush(y_53);
  Rpush(z_53);
  goto z_89;
  z_53 :
...
PROC(_stratego_g_97)
  ...
  goto m_105;
  v_60 :
  TestFunFC(n_58,&&c_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto n_105;
  c_61 :
  TestFunFC(r_58,&&e_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto o_105;
  e_61 :
  TestFunFC(v_58,&&f_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto p_105;
  f_61 :
  TestFunFC(y_58,&&l_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  MoveArg(0,4,0,1,2);
  Rpush(p_60);
  goto q_105;
  l_61 :
  TestFunFC(g_59,&&m_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto r_105;
  m_61 :
  TestFunFC(c_49,&&n_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto s_105;
