...
PROC(_stratego_init_afuns)
  ...
  MOVE(v_58,ATmakeAFun("BAM",3,0));
  MOVE(r_58,ATmakeAFun("BA",2,0));
  MOVE(o_58,ATmakeAFun("AM",2,0));
...
PROC(_stratego_g_97)
  ...
  goto q_105;
  f_61 :
  TestFunFC(e_59,&&g_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto r_105;
  g_61 :
  TestFunFC(c_49,&&h_61,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  Rpush(p_60);
  goto s_105;
