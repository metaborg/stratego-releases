...
PROC(_stratego_i_51)
  ...
  j_30 :
  Ccontinue(k_30);
  Ccall(_stratego_o_51);
  goto h_30;
  k_30 :
  Ccontinue(l_30);
  Ccall(_stratego_p_51);
  goto h_30;
  l_30 :
