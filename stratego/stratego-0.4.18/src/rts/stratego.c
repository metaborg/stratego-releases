...
$Id: stratego.c,v 1.41 2000/10/18 12:06:19 visser Exp $
...
void *_TestIntFC(int i, void *fc, ATerm t)
{
...
void *_TestRealFC(double i, void *fc, ATerm t)
{
...
void *_TestStringFC(char *s, void *fc, ATerm t)
{
...
void *_TestFunFC_oldest(char *f, int n, void *fc, ATerm t)
{
  assert(t != NULL);
  if(!t_is_appl(t)
...
void *_TestFunFC_old(char *f, int n, void *fc, ATerm t)
{
...
void *_TestFunFC(AFun fun, void *fc, ATerm t)
{
  assert(t != NULL);
  if(!t_is_appl(t) || ATgetAFun((ATermAppl) t) != fun)
      return fc;
