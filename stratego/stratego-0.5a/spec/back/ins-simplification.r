...
% $Id: ins-simplification.r,v 1.5 2000/09/20 08:08:25 visser Exp $
...
\begin{code}
  ...
  // leave this for the C compiler to avoid getting warnings in
  // case that the label is not used anywhere.
