...
PROC(_stratego_init_afuns)
  ...
  MOVE(a_2,ATmakeAFun("Eq",2,0));
  MOVE(z_1,ATmakeAFun("Impl",2,0));
  MOVE(w_0,ATmakeAFun("Not",1,0));
  MOVE(p_0,ATmakeAFun("Or",2,0));
  MOVE(n_0,ATmakeAFun("And",2,0));
ENDPROC
...
PROC(_stratego_o_2)
  ...
  goto c_1;
  c_1 :
  TestFunFC(n_0,&&m_0,Egetd(0,4));
  MoveArg(0,5,0,4,0);
  MoveArg(0,1,0,4,1);
  goto d_1;
  d_1 :
  TestFunFC(p_0,&&o_0,Egetd(0,1));
  MoveArg(0,2,0,1,0);
  MoveArg(0,3,0,1,1);
  goto e_1;
  e_1 :
  TestFunFC(p_0,&&q_0,Egetd(0,5));
  MoveArg(0,6,0,5,0);
  MoveArg(0,7,0,5,1);
  Cpush(s_0);
  Rpush(t_0);
  ...
  goto g_1;
  g_1 :
  TestFunFC(w_0,&&m_1,Egetd(0,5));
  MoveArg(0,6,0,5,0);
  Rpush(l_0);
  goto z_0;
  m_1 :
  TestFunFC(n_0,&&n_1,Egetd(0,5));
  MoveArg(0,6,0,5,0);
  MoveArg(0,7,0,5,1);
  Rpush(l_0);
  goto a_1;
